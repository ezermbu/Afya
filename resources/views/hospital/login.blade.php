...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <h1 class="text-center">Connexion Hôpital</h1>
        ...
        <div class="image-container">
            <div>
                <h2>Bienvenue sur l'interface hôpital</h2>
                <p>Cette zone est réservée aux gestionnaires autorisés de l'hôpital. En tant qu'utilisateur hôpital, vous aurez accès à des fonctionnalités spécifiques pour gérer les informations et les services de votre établissement.</p>
            </div>
        </div>
    </div>
